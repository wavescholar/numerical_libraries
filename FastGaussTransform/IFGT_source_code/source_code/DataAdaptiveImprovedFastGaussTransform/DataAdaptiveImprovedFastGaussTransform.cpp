...
//-------------------------------------------------------------------
// File    : DataAdaptiveImprovedFastGaussTransform.cpp
...
DataAdaptiveImprovedFastGaussTransform::~DataAdaptiveImprovedFastGaussTransform()
{
	delete []ry_square;
	delete []ry;
	delete []C;
...
int
DataAdaptiveImprovedFastGaussTransform::nchoosek(int n, int k){
	int n_k = n - k;
...
int
DataAdaptiveImprovedFastGaussTransform::return_p(double a_square, int cluster_index)
{
...
//-------------------------------------------------------------------
void
DataAdaptiveImprovedFastGaussTransform::compute_constant_series(){
...
//-------------------------------------------------------------------
void
DataAdaptiveImprovedFastGaussTransform::compute_source_center_monomials(int p)
{		
...
//-------------------------------------------------------------------
void
DataAdaptiveImprovedFastGaussTransform::compute_target_center_monomials()
{		
...
void
DataAdaptiveImprovedFastGaussTransform::Evaluate()
{
