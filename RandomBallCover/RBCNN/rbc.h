...
void searchExact(matrix,matrix,matrix,rep*,unint*,float*);
void searchExactK(matrix,matrix,matrix,rep*,unint**,float**,unint);
void searchExactManyCores(matrix,matrix,matrix,rep*,unint*,float*);
void searchExactManyCoresK(matrix,matrix,matrix,rep*,unint**,float**,unint);

void buildOneShot(matrix,matrix*,rep*,unint);
void searchOneShot(matrix,matrix,matrix,rep*,unint*);
void searchOneShotK(matrix,matrix,matrix,rep*,unint**,float**,unint);
