...
void brutePar(matrix X, matrix Q, unint *NNs, float *dToNNs){
  float temp[CL];
  int i, j, k, t;
...
void rangeCount(matrix X, matrix Q, float *ranges, unint *counts){
  float temp;
  unint i, j, k;
...
void bruteMap(matrix X, matrix Q, rep *ri, unint* qMap, unint *NNs, float *dToNNs){
  unint i, j, k;
...
// RBC method.
void bruteList(matrix X, matrix Q, rep *ri, intList *toSearch, unint numReps, unint *NNs, float *dToNNs){
  float temp;
  unint i, j, k, l;
