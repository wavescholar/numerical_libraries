...
extern "C" int sdpa_EX6 ()
{
	...
	Problem1.pARAM.maxIteration 	= 50;
        Problem1.pARAM.epsilonStar   	= 1.0E-4;
...
/*	Jun 22, 2000 -------> */
	...
	if (Problem1.Value == pdOPT)
	   fprintf(stdout, "phase       = pdOPT\n\n");
	else if (Problem1.Value == pdFEAS)
	   fprintf(stdout, "phase	= pdFEAS\n\n");
	else if (Problem1.Value == pFEAS)
	   fprintf(stdout, "phase	= pFEAS\n\n");
	else if (Problem1.Value == dFEAS)
	   fprintf(stdout, "phase	= dFEAS\n\n");
	else if (Problem1.Value == noINFO)
	   fprintf(stdout, "phase	= noINFO\n\n");
