...
class ARGenEig:
 ...
 // d.1) Function that stores user defined parameters.
  ...
  /* bbcedit virtual void DefineParameters(int np, int nevp, FOP* objOPp,
	 ...
	 virtual void	 DefineParameters(int np, int nevp, FOP* objOPp, 
										...
										FB* objBp,  void (FB::* MultBxp)(TYPE[], TYPE[]), 
char* whichp,int ncvp, FLOAT tolp, int maxitp, TYPE* residp, bool ishiftp);
