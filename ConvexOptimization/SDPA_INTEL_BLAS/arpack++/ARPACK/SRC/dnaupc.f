...
c           ===> OP = inv[A - sigma*M]*[A - mu*M]  and  B = M. 
...
c          communication (IPARAM(1)=0), dnaupc returns NP, the number
...
c     of NCV relative to NEV.  The only formal requrement is that 
c     NCV .ge. NEV + 2.
